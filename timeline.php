...
<body style="background: #f1f1f1">
    ...
    $(function() {
      $('.ui.form').form({
        Site: {
          ...
          {
            type : 'empty',
            prompt : 'Selecione o site que deseja avaliar '
          }
          ]
        },
        empresa: {
          ...
          {
            type : 'empty',
            prompt : 'Selecione a empresa que deseja avaliar'
          }
          ]
        },
        Veracidade: {
  ...
  <div class="ui centered stackable  column grid" id="tudo">
   <?php
   if (isset($_SESSION['message_timeline'])){
    ...
    right: 3%;
    top: 15%;
    " class="ui '.$_SESSION['message_timeline_type'].' message">
    <i class="close icon"></i>
    <div class="header">
      Sucesso
    </div>
    <p>'.$_SESSION['message_timeline'].'</p>
  </div>';
  unset($_SESSION['message_timeline']);
}
?>
  ...
  <script type="text/javascript" language="javascript">
    ...
    <div id="semavaliacao" class="ui centered column">
      <div class="ui segment">
        <h3>Siga um amigo ou faça uma avaliação agora.</h3>
      </div>
    </div>
    <?php
  }
